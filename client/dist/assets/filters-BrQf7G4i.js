import{s as t,b as v}from"./presentation-p9mWjcX8.js";function y(s,a){const p=t.get("companies"),r=t.get("selectedCompanyIds"),d=t.get("dateFrom"),f=t.get("dateTo"),o=t.get("filterOptions");s.innerHTML=`
